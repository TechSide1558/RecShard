    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "RecShard Intro";
                Console.WriteLine("Welcome to RecShard " + appversion + "!");
                Console.WriteLine("Is this your first time using RecShard?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "RecShard Tutorial";
                    Console.WriteLine("In that case, welcome to RecShard!");
                    Console.WriteLine("RecShard is server software that emulates the old servers of previous RecRoom versions.");
                    Console.WriteLine("To use RecShard, you'll need to have builds aswell!");
        ...
        Start:
            Console.Title = "RecShard Startup Menu";
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("RecShard - Open source Old RecRoom server software. (Version: " + appversion + ")");
            Console.WriteLine("Made and provided by TechSide.");
            ...
            {
                Console.WriteLine("This version of RecShard is outdated. We recommend you install the latest version, RecShard " + new WebClient().DownloadString("https://raw.githubusercontent.com/recroom2016/OpenRec/master/Download/version.txt"));
            }
            ...
            if (readline == "1")
            {
                Console.Title = "RecShard Changelog";
                Console.Clear();
            ...
            if (readline == "2")
            {
                ...
                Settings:
                Console.Title = "RecShard Settings Menu";
                ...
                {
                    Console.Title = "RecShard Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                Console.Title = "RecShard Profile Menu";
                ...
                {
                    Console.Title = "RecShard Profile Downloader";
                    Console.Clear();
                    Console.WriteLine("Profile Downloader: This tool takes the username and profile image of any username you type in and imports it to RecShard.");
            ...
            if (readline == "4")
            {
                Console.Title = "RecShard Build Downloads";
                Console.Clear();
                Console.WriteLine("To download builds, either go to the builds channel or use the links below: (these links are also available from the #builds channel)" + Environment.NewLine);
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/recroom2016/OpenRec/master/Update/builds.txt"));
                Console.WriteLine("Download a build and press any key to continue:");
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "RecShard October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "RecShard May 30th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RecShard September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RecShard July 20th 2018";
                        version = "2018";
                        Console.Clear();
